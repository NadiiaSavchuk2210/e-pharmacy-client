...
export type AuthFieldConfig<TName extends string = string> = {
  name: TName;
  label: string;
...
type AuthTextFieldProps<TName extends string> = AuthFieldConfig<TName> & {
  formatValue?: (value: string) => string;
  normalizeValue?: (value: string) => string;
  className?: string;
};

const AuthTextField = <TName extends string>({
  name,
  label,
  formatValue,
  normalizeValue,
