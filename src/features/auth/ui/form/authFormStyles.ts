...
export const AUTH_FORM_FOOTER_STYLES = {
  register: {
    ...
    navigationLink:
      'w-full text-center text-12 font-normal leading-18 text-text-muted transition-colors hover:text-text md:max-w-[280px] lg:w-[calc((100%_-_var(--space-14))_/_2)]',
  },
  login: {
    submitWrapper:
      'mt-[118px] mb-1 w-full flex text-14 leading-18 md:mt-[48px] md:mb-0 md:max-w-full lg:mt-[48px] lg:max-w-full',
    navigationLink:
      'w-full text-center text-12 font-normal leading-18 text-text-muted transition-colors hover:text-text md:max-w-full lg:max-w-full',
  },
